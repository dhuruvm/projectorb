---
    title: "Project Glasswing — Initial Update (May 22, 2026)"
    source: https://www.anthropic.com/research/glasswing-initial-update
    saved: 2026-07-18
    description: >
    First progress report: vulnerability counts, partner findings, OpenSSF partnership, ExploitBench/ExploitGym benchmarks, and next steps.
    ---
