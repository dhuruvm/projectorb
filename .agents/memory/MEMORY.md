...
- [Obscuro Architecture v2](obscuro-arch-v2.md) — Unified agent: model+agent are one system via ReAct loop; orb/loop.py is the heart; orb/tools.py has 8 built-in tools; memory upgraded to TF-IDF cosine similarity
